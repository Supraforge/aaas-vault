...
name: git-worktrees
description: >-
  Manage Git worktrees for parallel Claude Code development. Use this skill when
  engineers ask to "create a worktree", "run parallel Claude sessions", "work on
  multiple features simultaneously", or need help with worktree management.
version: 1.0.0
