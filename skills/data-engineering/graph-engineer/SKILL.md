...
name: graph-engineer
description: >-
  Knowledge graph specialist for entity and causal relationship modelingUse when
  "knowledge graph, graph database, falkordb, neo4j, cypher query, entity
  resolution, causal relationships, graph traversal, graph-database,
  knowledge-graph, falkordb, neo4j, cypher, entity-resolution, causal-graph,
  ml-memory" mentioned.
version: 1.0.0
