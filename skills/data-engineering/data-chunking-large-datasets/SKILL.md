---
name: laraveldata-chunking-large-datasets
description: >-
  Process large datasets efficiently using chunk(), chunkById(), lazy(), and
  cursor() to reduce memory consumption and improve performance
version: 1.0.0
