...
description: >-
  Build comprehensive attack trees to visualize threat paths. Use when mapping
  attack scenarios, identifying defense gaps, or communicating security risks to
  stakeholders.
version: 1.0.0
dependencies:
  - python3
