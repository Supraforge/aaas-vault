...
name: documentation
description: >
  Complete documentation infrastructure. Audits current docs, generates missing
  pieces,

  updates stale content, and verifies everything works. Every run does the full
  cycle.
