...
name: wp-debugging
description: >-
  WordPress debugging, dependency checking, and local development patterns. Use
  when debugging WordPress issues, checking plugin dependencies, setting up
  local environments, resolving conflicts, or troubleshooting errors in themes
  and plugins.
version: 1.0.0
