...
name: clawdbites
description: >-
  Extract recipes from Instagram reels. Use when a user sends an Instagram reel
  link and wants to get the recipe from the caption. Parses ingredients,
  instructions, and macros into a clean format.
  ...
  clawdbot:
    ...
    install:
      ...
      - id: whisper
        ...
        label: 'Install Whisper (local, no API key)'
version: 1.0.0
