...
description: >-
  ...
  product - which leads to retention, expansion, and advocacy.  This skill
  covers onboarding that activates, health scoring that predicts, retention
  plays that save, and expansion strategies that grow accounts. Use when
  "keywords, file_patterns, contexts, " mentioned.
version: 1.0.0
