...
name: clarify-spec
description: >
  AKTIVIERT SICH AUTOMATISCH bei vagen Auftraegen. LIEBER EINMAL ZU OFT
  NACHFRAGEN als falsch implementieren.
  ...
  - Vage Verben: besser, optimieren, fixen, machen, aendern, verbessern,
  anpassen, erweitern, refactoren, aufraumen, ueberarbeiten

  - Unsichere Sprache: irgendwie, vielleicht, mal eben, schnell, einfach,
  bisschen, koennte, sollte
  ...
  Escape: mach einfach, keine Rueckfragen, entscheide selbst ueberspringt
  Klaerung.
triggers:
  - /clarify
  - /spec
