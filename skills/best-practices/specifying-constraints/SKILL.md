---
name: laravelspecifying-constraints
description: >-
  Define clear constraints—performance, security, testing, architecture,
  dependencies—so AI generates code that meets your project standards
version: 1.0.0
