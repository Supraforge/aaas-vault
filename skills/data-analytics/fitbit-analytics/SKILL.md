...
description: >-
  Fitbit health and fitness data integration. Fetch steps, heart rate, sleep,
  activity, calories, and trends from Fitbit Web API. Generate automated health
  reports and alerts. Requires FITBIT_CLIENT_ID, FITBIT_CLIENT_SECRET,
...
metadata:
  clawdbot:
    ...
    homepage: 'https://github.com/kesslerio/fitbit-analytics-clawdbot-skill'
version: 1.0.0
