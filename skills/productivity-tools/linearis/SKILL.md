...
version: 1.0.0
description: >-
  Linear.app CLI for issue tracking. Use for listing, creating, updating, and
  searching Linear issues, comments, documents, cycles, and projects. Optimized
  for LLM agents with JSON output.
metadata:
  clawdbot:
    emoji: "\U0001F4CB"
    requires:
