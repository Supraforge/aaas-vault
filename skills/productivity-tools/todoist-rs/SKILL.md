...
name: todoist
description: >-
  Manage Todoist tasks. Use when the user mentions "todoist", "my tasks", "task
  list", "add a task", "complete task", or wants to interact with their Todoist
  account.
...
metadata:
  clawdbot:
    ...
    install:
      - id: brew
        kind: brew
        formula: LuoAndOrder/tap/todoist-cli
        bins:
          - td
        label: Install todoist-cli via Homebrew
version: 1.0.0
