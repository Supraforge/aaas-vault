...
name: confluence
description: >-
  Search and manage Confluence pages and spaces using confluence-cli. Read
  documentation, create pages, and navigate spaces.
homepage: 'https://github.com/pchuri/confluence-cli'
metadata:
  clawdbot:
    emoji: "\U0001F4C4"
    primaryEnv: CONFLUENCE_TOKEN
    requires:
      bins:
        - confluence
      env:
    ...
    install:
      - id: npm
        kind: node
        package: confluence-cli
        bins:
          - confluence
        label: Install confluence-cli (npm)
version: 1.0.0
