...
description: >-
  Embedding and vector retrieval expert for semantic searchUse when "vector
  search, embeddings, semantic search, qdrant, pgvector, similarity search,
  reranking, hybrid retrieval, embeddings, vector-search, qdrant, pgvector,
  semantic-search, retrieval, reranking, ml-memory" mentioned.
version: 1.0.0
