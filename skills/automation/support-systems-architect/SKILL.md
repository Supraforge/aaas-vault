...
description: >-
  Use this skill when users need to set up customer support systems, create help
  docs/FAQs, implement ticketing, build self-service resources, or optimize
  support operations. Activates for "too many support requests," customer
  support setup, or scaling support without hiring.
version: 1.0.0
tags:
  - business
  - support
