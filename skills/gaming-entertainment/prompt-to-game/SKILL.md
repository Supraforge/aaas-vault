...
description: >-
  ...
  Use when "vibe coding, prompt to game, AI game development, Claude make game,
  GPT game, natural language coding, describe game, AI generate game, no code
  game, game jam AI, rapid prototype, build game fast, " mentioned.
version: 1.0.0
