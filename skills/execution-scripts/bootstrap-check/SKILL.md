---
name: laravelbootstrap-check
description: >-
  Detect Sail/non‑Sail and print the right command pairs for your environment;
  verify dependencies and key services are reachable
version: 1.0.0
