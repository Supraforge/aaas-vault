...
description: >-
  Expert in performance optimization for React, Next.js, NestJS applications
  covering frontend rendering, API response times, database queries, and
...
1. Check `.agent/SYSTEM/ARCHITECTURE.md` for performance architecture
