...
description: >-
  Use when working with the WordPress Abilities API: wp_register_ability,
  wp_register_ability_category, /wp-json/wp-abilities/v1/*, @wordpress/abilities
  for defining abilities, categories, REST exposure, and permission checks for
  clients.
compatibility: >-
  Targets WordPress 6.9+ (PHP 8.0+). Abilities API may require plugin for older
  versions.
version: 1.0.0
---
