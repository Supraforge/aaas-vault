...
description: >-
  ...
  relationships as it is about code quality. Use when "code review, PR feedback,
  review comments, how to give feedback, harsh review, review culture,
  constructive criticism, " mentioned.
version: 1.0.0
