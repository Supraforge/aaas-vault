...
name: test-architect
description: >-
  Testing strategy specialist for test pyramid design, test isolation,
  property-based testing, and quality gatesUse when "testing, test strategy,
  unit test, integration test, e2e, property testing, test pyramid, flaky test,
  test coverage, quality gate, testing, pytest, jest, unit-testing,
  integration-testing, e2e, property-testing, tdd, quality, ml-memory"
  mentioned.
version: 1.0.0
