...
name: phone-calls
description: >-
  Make AI-powered phone calls via Bland AI - book restaurants, make
  appointments, inquire about services. The AI calls on your behalf and reports
  back with transcripts.
metadata:
  clawdbot:
    emoji: "\U0001F4DE"
    requires:
