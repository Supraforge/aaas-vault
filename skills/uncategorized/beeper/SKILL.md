...
name: beeper
description: >-
  Search and browse local Beeper chat history (threads, messages, full-text
  search).
...
metadata:
  clawdbot:
    ...
    install:
      - id: go
        kind: go
        pkg: github.com/krausefx/beeper-cli/cmd/beeper-cli
        bins:
          - beeper-cli
        label: Install beeper-cli (go install)
version: 1.0.0
