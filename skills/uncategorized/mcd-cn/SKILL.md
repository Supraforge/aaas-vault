...
description: >-
  ...
  coupons, and auto-claiming. Use for human-friendly coupon lookup or JSON
  output for scripts.
...
metadata:
  clawdbot:
    ...
    requires:
      ...
      env:
        - MCDCN_MCP_TOKEN
    primaryEnv: MCDCN_MCP_TOKEN
    install:
      - id: brew
        kind: brew
        formula: ryanchen01/tap/mcd-cn
        bins:
          - mcd-cn
        label: Install mcd-cn (brew)
version: 1.0.0
