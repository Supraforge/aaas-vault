...
description: >-
  Use when reviewing WordPress PHP code for performance issues, auditing
  themes/plugins for scalability, optimizing WP_Query, analyzing caching
  strategies, or detecting anti-patterns in database queries, hooks, object
  caching, AJAX, and template loading.
