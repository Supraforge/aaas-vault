...
description: >-
  Design and implement event stores for event-sourced systems. Use when building
  event sourcing infrastructure, choosing event store technologies, or
  implementing event persistence patterns.
version: 1.0.0
dependencies: []
inputs:
  - name: input_1
