...
description: >-
  Build agents specialized in conducting thorough research, gathering
  information from multiple sources, and synthesizing findings. Covers research
  planning, source evaluation, and report generation. Use when automating market
  research, competitive analysis, literature reviews, or intelligence gathering.
version: 1.0.0
