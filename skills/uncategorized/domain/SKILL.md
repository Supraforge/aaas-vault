...
name: domainkits
description: >-
  Domain intelligence toolkit - search newly registered domains (NRDS) by
  keyword and reverse lookup domains by nameserver (NS Reverse). For domain
  investors, brand protection, and research.
metadata:
  clawdbot:
    emoji: "\U0001F310"
    requires:
