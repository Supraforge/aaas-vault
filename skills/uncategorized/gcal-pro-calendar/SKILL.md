...
description: >-
  ...
  events. Use when the user asks about their schedule, wants to add/edit/delete
  events, check availability, or needs a morning brief. Supports natural
  language like "What's on my calendar tomorrow?" or "Schedule lunch with Alex
  at noon Friday." Free tier provides read access; Pro tier ($12) adds
  create/edit/delete and morning briefs.
version: 1.0.0
