...
description: >-
  Turn nearby BLE MAC addresses into soulbound `$ANIMA` tokens using AnimaChain
  logic. Hashes each MAC into a unique proof-of-remnant and stores locally in a
  DAG.
version: 1.0.0
