...
description: >-
  Expert in writing documentation that developers actually read. Covers README
  craft, API docs, tutorials, and internal docs. Understands that docs are a
  product—they need UX, marketing, and user empathy. Use when "documentation,
  readme, write docs, api docs, tutorial, how to document, explain this, "
  mentioned.
version: 1.0.0
