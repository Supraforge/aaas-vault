...
name: swift-expert
description: >-
  Use when building iOS/macOS applications with Swift 5.9+, SwiftUI, or
  async/await concurrency. Invoke for protocol-oriented programming, SwiftUI
  state management, actors, server-side Swift.
triggers:
  - Swift
  - SwiftUI
  - iOS development
