...
name: nanoleaf
description: >-
  Control Nanoleaf light panels via the Picoleaf CLI. Use for turning Nanoleaf
  on/off, adjusting brightness, setting colors (RGB/HSL), changing color
  temperature, or any Nanoleaf lighting control.
  ...
  clawdbot:
    ...
    install:
      ...
      - id: binary
        ...
        command: >-
          curl -sL
          https://github.com/tessro/picoleaf/releases/latest/download/picoleaf_1.4.0_linux_amd64.tar.gz
          | tar xz -C ~/.local/bin
        bins:
          - picoleaf
