---
name: laraveltransactions-and-consistency
description: >-
  Wrap multi-write operations in transactions; use dispatchAfterCommit and
  idempotency patterns to ensure consistency
version: 1.0.0
