...
name: paperless
description: >-
  Interact with Paperless-NGX document management system via ppls CLI. Search,
  retrieve, upload, and organize documents.
emoji: "\U0001F4C4"
metadata:
  clawdbot:
    requires:
    ...
    install:
      - id: node
        kind: node
        package: '@nickchristensen/ppls'
        bins:
          - ppls
        label: Install ppls CLI (npm/bun)
version: 1.0.0
