...
name: tiempo
description: >-
  Use when working with dates, times, timezones, or datetime conversions in
  TypeScript/JavaScript. Provides guidance on using the tiempo library for
  timezone-safe datetime handling with the Temporal API.
version: 1.0.0
