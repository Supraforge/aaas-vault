...
description: >-
  Transform AI-sounding writing into natural, human prose. Use when creating or
  editing any written content—articles, essays, reports, emails, social posts,
  scripts, or marketing copy—to avoid patterns that signal AI authorship.
  Triggers on requests to "make it sound human," "less AI," "more natural,"
  improve voice/tone, or any writing task where authentic style matters.
version: 1.0.0
