...
name: trein
description: >-
  Query Dutch Railways (NS) for train departures, trip planning, disruptions,
  and station search via the trein CLI.
  ...
  clawdbot:
    ...
    install:
      ...
      - id: download-mac-arm
        kind: download
        url: >-
          https://github.com/joelkuijper/trein/releases/latest/download/trein-darwin-arm64
        bins:
          - trein
      ...
      - id: download-mac-x64
        kind: download
        url: >-
          https://github.com/joelkuijper/trein/releases/latest/download/trein-darwin-x64
        bins:
          - trein
      ...
      - id: download-linux
        kind: download
        url: >-
          https://github.com/joelkuijper/trein/releases/latest/download/trein-linux-x64
        bins:
          - trein
