...
name: beads
description: >-
  Beads (bd) distributed git-backed issue tracker for AI agents: hash-based IDs,
  dependency graphs, worktrees, molecules, sync. Keywords: bd, beads, issue
  tracker, git-backed, dependencies, molecules, worktree, sync, AI agents.
version: 0.49.1
