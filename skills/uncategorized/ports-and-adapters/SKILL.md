---
name: laravelports-and-adapters
description: >-
  Use hexagonal architecture for external systems; define ports (interfaces) and
  per-provider adapters; select adapter at composition edge
version: 1.0.0
