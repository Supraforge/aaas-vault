...
description: >-
  Use when working with WP-CLI for WordPress operations: safe search-replace, db
  export/import, plugin/theme management, cron, cache flushing, multisite, and
  automation with wp-cli.yml.
compatibility: >-
  Targets WordPress 6.9+ (PHP 8.0+). Requires WP-CLI in the execution
  environment.
version: 1.0.0
---
