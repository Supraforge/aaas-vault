---
name: laravelroutes-best-practices
description: >-
  Keep routes clean and focused on mapping requests to controllers; avoid
  business logic, validation, or database operations in route files
version: 1.0.0
