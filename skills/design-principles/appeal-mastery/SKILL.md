...
name: appeal-mastery
description: >-
  Use when designing character personalities, creating memorable motion
  signatures, ensuring animations feel polished, or making visual experiences
...
1. **Prioritizing realism over appeal**: Technically accurate but visually boring
2. **Over-designing**: Too complex to read clearly
3. **Generic motion**: Nothing distinctive or memorable
4. **Inconsistent personality**: Motion that feels random, not characteristic
5. **Rough execution**: Unpolished details that undermine overall appeal
